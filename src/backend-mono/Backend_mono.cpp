...
int main(int argc, const char* argv[]) {
    ...
    setsockopt(socket_servidor, SOL_SOCKET, SO_RCVTIMEO, (char *) &tv, sizeof(struct timeval));
    */
    ...
    if (listen(socket_servidor, 50) == -1) {
